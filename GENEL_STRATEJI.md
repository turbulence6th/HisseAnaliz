# Portföy Genel Strateji Belgesi (1 Mayıs 2026 İtibarıyla)
...
### 1.3. Kâr Kalitesi Analizi İlkesi (YENİ — 1 Mayıs 2026)

*   **GEREKÇE:** Q1 2026 THYAO analizi sırasında edinilen kritik ders: Gelir tablosundaki "net kâr" başlığı, şirketin çekirdek faaliyetlerinden bağımsız kalemler (finansal yatırım faiz geliri, ertelenmiş vergi geliri, varlık satış karları) nedeniyle yanıltıcı olabilir.
*   **KRİTERLER:** Bir şirketin kâr kalitesini değerlendirirken şu ayrımlar yapılacak:
    *   **Esas Faaliyet Kârı (EBIT):** Gerçek operasyonel performansın göstergesi. Pozitif olması tercih edilir.
    *   **Finansal Yatırım / Faiz Gelirleri:** Nakit zengini şirketlerde yapısal avantajdır; ancak "operasyonel turnaround" olarak sunulmamalıdır.
    *   **Ertelenmiş Vergi Geliri:** Nakit dışı muhasebe kalemi; normalize kâr hesaplamasında dışarıda bırakılır.
    *   **Tek Seferlik Kalemler:** Varlık satış karları, sigorta tazminatları, devlet teşvikleri — tekrarlayan olmayan gelirler işaretlenmeli.
*   **UYGULAMA:** Her analizde "Düzeltilmiş Esas Faaliyet Kârı" ayrıca hesaplanacak. "Kâra geçiş" haberleri Dipnot bazında doğrulanacak.

### 1.4. Makro Görünüm ve Riskler: Avrupa Pazarı Daralması (YENİ)
...
*   **STRATEJİ:**
    ...
    *   **Negatif İzleme Listesi:** VESTL (Talep daralması teyitli), VESBE (Avrupa talebi çöküşü — Q1 2026'da hasılat -%52.2 reel, EBITDA negatif, iflas riski), EREGL (Kota riski), YUNSA (Lüks tüketim daralması), TTRAK (İhracat düşüşü).
    *   **⚠️ VESBE (Vestel Beyaz Eşya) — Q1 2026 ÇÖKÜŞ TEYIT EDİLDİ:** Reel hasılat -%52.2, brüt kâr marjı -%2.4 (negatif!), EBITDA yaklaşık -747M TL, net finansal borç 24.4B TL (piyasa değerinin 2.1 katı), nakit yalnızca 237M TL. Avrupa beyaz eşya talebi riskleri tam anlamıyla gerçekleşti. **🔴 KESİNLİKLE UZAK DUR.**
...
*   **ANA BULGULAR:**
    ...
    *   **KORDS (🟢 toparlanma):** Q1 2026 net zarar → net kâra geçiş. EBIT +%203, Net Borç/FAVÖK 7.7x → 3.2x (annualize). Endonezya fabrikası toparlanıyor. Karar 🟡 → 🟢 Kademeli Al revize edildi.
    *   **VESBE (🔴 kötüleşti):** Avrupa talebi riski tam anlamıyla gerçekleşti. Reel hasılat -%52.2, brüt kâr negatife döndü, EBITDA ~-747M TL. Net finansal borç 24.4B TL = piyasa değerinin 2.1 katı. Finansal çöküş dinamikleri aktif.
*   **KÂR KALİTESİ UYARISI (Yeni İlke — bkz. 1.3):** Q1 analizleri, bir şirketin "kâra geçiş" haberinin esas faaliyetlerden değil finansal yatırım gelirleri veya ertelenmiş vergiden kaynaklanabileceğini gösterdi. Bundan böyle tüm analizlerde Dipnot bazında kâr kaynağı ayrıştırması yapılacak.
...
### 2.2. Önceki İterasyon Özeti (6 Mart 2026)

> *Arşiv — referans amaçlı korunuyor.*

*   **DURUM:** FY2025 (12 aylık tam yıl) bilanço dönemi tamamlandı. Bu iterasyonda TCELL, THYAO ve SAHOL analizleri tamamlandı; md dosyaları güncellendi. Genel tablo: TMS 29 etkisinden minimal etkilenen (THYAO, SAHOL) şirketlerde kâr kalitesi yüksek; değerleme cazip seviyelerde.
*   **TAMAMLANAN ROTASYON:** KORDS → AGESA rotasyonu gerçekleştirildi. KORDS portföyden çıktı; AGESA çekirdek varlık olarak alındı.
*   **YENİ ANALIZLER (6 Mart 2026):**
    *   TCELL (FY2025): FCF Yield %16.8, FAVÖK marjı %43.1, EV/FAVÖK 2.82x — portföydeki en güçlü temel hikaye koruyor. 🟢 AL kararı sürdü.
    *   THYAO (FY2025): F/K 3.33x, FCF Yield %26.8, PD/DD 0.43x — kira hariç net nakit. Karar: 🟢 AL.
    *   SAHOL (FY2025): Turnaround tamamlandı. Normalize F/K ~7.1x, PD/DD 0.54x. Karar: 🟢 AL.
*   **FİYAT HAREKETLERİ (27 Şubat → 6 Mart 2026):**
    *   YKBNK: 43.92 → 35.92 TL (-%18.2) ⚠️ — Alım seviyeleri devreye girdi
    *   SISE: 46.04 → 40.48 TL (-%12.1) — Eurobond itfası (14 Mart) baskısı
    *   AGESA: ~234 → 213.30 TL (-%8.9)
    *   TUPRS: 216.20 → 252.25 TL (+%16.7) 🟢 — Temettü öncesi yükseliş
    *   ASELS: 309.25 → 338.75 TL (+%9.5) 🟢 — Savunma sektörü talebi
*   **YENİ FY2025 ANALİZLERİ (Bu iterasyon):**
    *   THYAO: F/K 3.33x, FCF Yield %26.8, PD/DD 0.43x — kira hariç NET NAKİT. Karar: 🟢 AL.
    *   SAHOL: Turnaround tamamlandı (FY2024 zarar → FY2025 kâr). Normalize F/K ~7.1x, PD/DD 0.54x. Karar: 🟢 AL.
*   **İZLENECEK RİSKLER:**
    *   SISE Eurobond itfası (700M USD — 14 Mart 2026): Yaklaşıyor; nakit 38.1B TL ile yönetilebilir ama piyasa baskı yapıyor.
    *   PGSUS: 52H dibine dayandı (176.40 TL); EUR bazında maliyet baskısı devam ediyor.
    *   THYAO: TFRS 16 kira yükü (638B TL) yüksek; yakıt maliyeti volatilitesi izlenmeli.
*   **GENEL STRATEJİ:** Çekirdek varlıklarda (TCELL, SISE, TUPRS, AGESA, THYAO, SAHOL) pozisyonu korumak ve güçlendirmek. YKBNK'da sert düşüş alım fırsatı sunuyor (35.92 TL = ağırlıklı alım bölgesi). Yeni spekülatif pozisyon açılmayacak.
...
#### TCELL (Turkcell)
*   **HÜKÜM:** 🟢 AL / GÜÇLENDİR (@ 107.70 TL — 06.03.2026)
*   **GEREKÇE (FY2025 Tam Yıl):** Portföydeki en güçlü temel hikayelerden biri; FY2025 verileriyle tez **beklentilerin üzerinde** teyit edildi. Hasılat +%41.3 → 241.5B TL; FAVÖK +%46.5 → 104.0B TL (marj %43.1 — sektör zirvesi); Sürdürülen Net Kâr +%22.6 → 17.8B TL (TMS 29 etkisi küçük, kâr büyük ölçüde gerçek). FCF Yield **%16.8** — piyasa değerinin %17'sini nakit üretiyor. EV/FAVÖK **2.82x** (net borç/FAVÖK 0.51x). Halka açıklık %53.9, imtiyazlı pay yok, Altın Hisse yok. TTKOM ile kıyaslandığında her metrikte belirgin üstünlük. Hedef: **167 TL** (+%55 yukarı potansiyel).
*   **ALIM SEVİYELERİ:** 🟡 Mevcut (107.70 TL) makul giriş | 🟢 100-105 TL → Ekle | 🟢🟢 92-97 TL → Ağırlıklı alım | 🛑 82 TL altı → Tezi sorgula
...
*   **GEREKÇE (Q1 2026 — Revize):** Q1 "kâra geçiş" haberi yanıltıcıdır. **Esas faaliyet zararda (-2,451M TL).** Net kâr (9,856M TL) büyük ölçüde: (1) finansal yatırım faiz geliri 15,226M TL [Dipnot 25] ve (2) ertelenmiş vergi geliri 5,538M TL tarafından sürükleniyor. THYAO'nın 135.5B TL net nakdinin faiz üretmesi gerçek bir bilanço avantajıdır; ancak bunu "operasyonel toparlanma" olarak okumak yanıltıcıdır. **GERÇEKTEN OLUMLU:** FAVÖK +%47.7 (25,907M TL), hasılat +%45.9, brüt kâr marjı %6.6 → %8.4, kargo +%56.1, ertelenmiş gelirler +%31.2 (yaz sezonu öncü göstergesi). **KRİTİK TEST:** Q2 2026'da esas faaliyet kârlılığının geri gelmesi gerekiyor.
*   **Değerleme:** F/K ~3.67x (FY2025 bazlı), PD/DD 0.45x, defter değeri ~700 TL — hâlâ iskontolu ama yeni alım için Q2 teyidi bekleniyor.
*   **52H:** 249.20 – 352.50 TL
...
*   **GEREKÇE (FY2025 + Portföy Satışları):** Turnaround tezi güçlendi. FY2025: Normalize F/K ~7.1x, PD/DD 0.54x, defter değeri/hisse 171.98 TL → %39 iskonto hâlâ sürüyor. **⚡ 17 Nisan 2026 çift satış duyurusu:**
    *   **CarrefourSA → Yeni Mağazacılık (A101):** Sabancı %57.12 payını $325M şirket değeri üzerinden satıyor. Sabancı'ya düşen nakit: ~$185M (~7B TL). Rekabet Kurumu onayı bekleniyor.
    *   **Akçansa → Heidelberg Materials:** Sabancı %39.72 payını $1.1B EV üzerinden sözleşmedeki ön alım hakkıyla Heidelberg'e satıyor. Sabancı'ya düşen nakit: ~$400-440M (~15-17B TL). Rekabet Kurumu onayı bekleniyor.
    *   **Toplam tahmini nakit girişi: ~$585-625M (~22-24 milyar TL).** Her iki satış da "dinamik portföy yönetimi" tezinin somutlaşması: düşük büyümeli döngüsel varlıklar (çimento, perakende) yüksek değerli nakde çevriliyor. Nakit Enerjisa genişlemesi/dijital/teknoloji ya da hissedar getirisi (temettü, geri alım) için kullanılabilir.
    *   **Risk:** CRFSA ve AKÇNS yıllık kar katkısı kesilecek; FY2026 net karı baskı altında kalabilir. Ancak ~$600M nakit bu açığı fazlasıyla karşılıyor.
*   **Teknik:** MA50 (97.99 TL) üzerinde ✅ | MA200 (91.10 TL) çok yukarısında ✅ | 17 Nisan: +%5.6 tek günde (katalizör etkisi). 90 TL giriş → 104 TL (+%15) tez doğrulandı.
*   **52H:** 72.20 – 112.60 TL | Yeni hedef: **112-120 TL** (52H yüksek aşımı + NAV artışı)
*   **SEVİYELER:** 🟡 Mevcut (104 TL) → TUT, yeni alım açma | 🟢 97-100 TL (MA50) geri çekilmesi → Ekle | 🟢🟢 91-95 TL (MA200) → Ağırlıklı ekle | 🎯 112-120 TL → Kısmi kâr al gündeme alınabilir | 🛑 88 TL altı → Tezi sorgula
...
*   **GEREKÇE (Q1 2026 teyit):** Q1 2026 sonuçları tezi güçlendirdi. Net kâr +%48.6 → 1,758M TL (Q1 2025: 1,182M TL). BES AUM rekor **441.2B TL** (+%9.9 tek çeyrekte). Temettü 6.94 TL ödendi (+%24.8 büyüme vs önceki yıl). **Risk:** Hayat dışı hasar oranı %82.6 (%78.1'den yükseldi) — izlenmeli. BES teknik zararı neredeyse sıfırlandı (-(8M) vs -(118M)). Sağlık sigortası (Medisa) büyüme katalizörü henüz tam fiyatlanmamış. @ 229 TL: F/K ann. ~5.9x, PD/DD 3.98x, 12-ay hedef 312 TL (+%36).
*   **ALIM SEVİYELERİ:** 🟡 Mevcut (229 TL) tut | 🟢 215-220 TL → Ekle | 🟢🟢 205-212 TL → Ağırlıklı alım | 🛑 195 TL (MA200 yakını) altı → Tezi sorgula
*   **52H:** 123.10 – 254.00 TL | Detay: `hisse-analiz/AGESA.md`


#### ORGE (Orge Enerji)
*   **HÜKÜM:** 🟢 TUT / KADEMELİ EKLE (@ 66.80 TL — 06.03.2026)
*   **GEREKÇE (FY2025 Tam Yıl):** 2025 bir "mola yılı": Hasılat -22.1% → 3.496B TL, Net Kâr -34.4% → 593.3M TL, EPS 7.416 TL. Ancak önemli olan bunlar değil: **Backlog 4.630B TL (rekor, +%20.5)** — yıllık hasılatın 1.32 katı kesinleşmiş iş yükü 2026'yı besleyecek. Net Nakit +204M TL, borçsuz bilanço. @ 66.80 TL: F/K 9.01x (düşük kâr yılına göre), PD/DD ~1.34x — bu backlog ve bilanço sağlığı için iskontolu. İmtiyazlı pay yok, Orhan Gündüz %30.65. DenizKoru Sarıyer projesi iptal edildi.
*   **52H:** 64.85 – 110.00 TL
*   **ALIM SEVİYELERİ:** 🟢 Mevcut seviye (65-68 TL) iyi giriş | 🟢🟢 64-65 TL → 52H desteğinde ağırlıklı alım | 1Ç2026 sonuçları (Mayıs 2026) önemli onay noktası | Detay: `hisse-analiz/ORGE.md`

#### ECILC (Eczacıbaşı İlaç)
*   **HÜKÜM:** 🟡 TUT / BEKLE — YENİ ALIM YAPMA (@ 108.70 TL — 03.04.2026)
*   **GEREKÇE:** PD/NAV **1.22x** — holding şirket için NAV üzerinde prim, yeni alım için cazip değil. Operasyonel taraf (hasılat -14%, EBIT -22%) zayıf; net kâr artışı tek seferlik yatırım gelirlerine yaslanıyor. Teknik: MA20 (113 TL) ve MA50 (117 TL) altında, kısa-orta vadeli baskı devam ediyor.
*   **ALIM SEVİYELERİ:** 🟡 PD/NAV ~1.0x → **85-90 TL** → Pozisyon güçlendir | 🟢 PD/NAV ~0.85x → **72-78 TL** → Agresif alım | 🛑 Şu anki seviye (108 TL) alım bölgesi değil
...
*   **HÜKÜM:** 🔴 UZAK DUR — ANA KATALİZÖR BELİRSİZ VADEYE ERTELENDİ (@ 86.4 TL — 05.05.2026)
*   **Özet:** Operasyonel performans güçlü: FAVÖK +%55, brüt kâr marjı %22.5 (+259 bps), satış hacmi +%16, Net Borç/FAVÖK 0.76x. Tek sorun yüksek TL borç maliyeti (%29-43) — EBIT'i tamamen absorbe ediyor, net kâr yalnızca 29M TL.
*   **Neden Uzak Duruyoruz:** **Enflasyon yüksek geldi → TCMB faiz indirimlerine ara verecek (5 Mayıs 2026).** Ana katalizör (faiz indirimleri) belirsiz vadeye ertelendi. Soruşturma + TİS riskleri de hâlâ aktif. SAHOL portföyde → dolaylı maruziyet yeterli.
*   **Yeniden Değerlendirme Koşulları:** TCMB faiz indirim döngüsü netleşirse + soruşturma kapanırsa
*   **Alım Seviyeleri:** 🔴 70-86 TL → Uzak Dur | 🟡 58-67 TL → Yalnızca faiz indirimi netleşirse küçük lot | 🟢 <55 TL → Faiz + soruşturma birlikte çözülürse
...
*   **Tez:** EPDK düzenlemeli elektrik dağıtım monopolü. DVT (Düzenlemeye Tabi Varlık Tabanı) 83.6 → 105.3 milyar TL tek çeyrekte +%26 büyüdü; 5. Uygulama Dönemi WACC %14.46 ile iyileştirildi. Finansman maliyeti %45.4 → %35.4'e geriledi. Baz Net Kâr Q1 2025'e göre +%80 (3.1 milyar TL). 2026 beklentisi: Baz Net Kâr 11-13 milyar TL → P/E **11-13x** (makul-ucuz). Temettü 2026 tahmini: 5.6-6.6 TL/hisse → getiri **%4.5-5.3**. İmtiyazlı pay YOK ✅, halka açıklık %20 ✅.
*   **Neden Şimdi Almıyoruz:** 52H zirvesi 127.90 TL; mevcut fiyat 124 TL bu zirvenin %97'si. 1 yılda +%127 performans. Geri çekilme bekleniyor. Ayrıca SAHOL portföyde olduğundan dolaylı Sabancı/Enerjisa maruziyeti mevcut.
*   **Risk:** Yüksek finansal borç (88.6 milyar TL, TLREF bazlı), perakende segment erimesi (SKT değişikliği), akıllı sayaç capex yükü (2027-2028).
*   **Alım Seviyeleri:** 🟡 122-128 TL → Bekle | 🟢 108-115 TL → Küçük başlangıç | 🟢 98-107 TL → Ekle | 🟢🟢 88-97 TL → Ağırlıklı alım | 🛑 <80 TL → Tezi sorgula
*   **Detay:** `hisse-analiz/ENJSA.md`

#### KORDS (Kordsa Teknik Tekstil)
*   **HÜKÜM:** 🟢 KADEMELİ AL (@ ~65 TL — 01.05.2026)
*   **GEREKÇE (Q1 2026):** Daha önce portföyden çıkarılmıştı (KORDS → AGESA rotasyonu). Q1 2026 sonuçları beklenenden güçlü toparlanma işaretledi: Net zarar → kâra geçiş, EBIT +%203 ($14.1M), Net Borç/FAVÖK 7.7x → 3.2x (annualize). USD fonksiyonel para birimi — TL değer kaybından koruma. Endonezya fabrikası toparlanıyor. Şüphe uyandıran kalemler: Endonezya'da $5.1M sigorta tazminatı (tek seferlik), $2.8M ticari alacak kur farkı. Bu tek seferlikler düşülünce çekirdek iyileşme hâlâ güçlü. **Net Borç** $322.8M — hâlâ yüksek ama düşüş trendinde.
*   **Beklenti:** Toparlanmanın Q2-Q3 2026'da da sürdüğü teyit edilmeli. Çekirdek pozisyon yeniden düşünülebilir.
*   **ALIM SEVİYELERİ:** 🟢 60-66 TL → Kademeli küçük lot | 🟢🟢 55-60 TL → Ekle | 🛑 50 TL altı → Toparlanma tezi sorgulan
*   Detay: `hisse-analiz/KORDS.md`

### C) Negatif İzleme / Uzak Dur Listesi

#### KAREL (Karel Elektronik) — Q1 2026 İncelendi
*   **HÜKÜM:** 🔴 KESİNLİKLE UZAK DUR (@ 11.47 TL — 04.05.2026)
*   **Birincil Red:** **İmtiyazlı hisse senedi** — A/B grubu paylar 2x oy hakkına sahip; A grubu Yönetim Kurulu'na 5 üye atama imtiyazı var. Strateji ilkesi gereği mutlak red.
*   **Ek Riskler:**
    *   **Sermaye artırımı seyreltmesi:** 805.9M pay → 1,750M pay hedefli artırım için SPK'ya başvuru yapılmış (~%54 seyreltme riski).
    *   **Borç/Özsermaye %310.9** — Net borç 5,230M TL, özsermaye 1,682M TL. Yüksek kaldıraç.
    *   **Süregelen net zarar:** Ana ortaklık payı -240.4M TL (Q1 2026). EBIT neredeyse başabaş (-12.4M TL) ama finansman yükü (-357.5M TL/çeyrek nakit faiz) eridi.
    *   **EMS segmenti yapısal sorunlu:** Elektronik Kart Üretimi brüt marjı -%35.6 (Q1 2025: -%24.6) — derinleşiyor.
    *   **Savunma marjı ani çöküş:** +%33.5 → -%4.5 (dönemsel olabilir ama izlenmeli).
    *   **Sürekli finansman bonosu döngüsü:** 560M TL itfa → hemen 615M TL yeni ihraç.
