# SISE – 2Ç 2025 Faaliyet Raporu Analizi ve Yeni Strateji

Bu not, Şişecam'ın 2Ç 2025 faaliyet raporu sonuçlarını analiz etmekte ve bu sonuçlar ışığında güncellenen yatırım stratejisini özetlemektedir.

## 2Ç 2025 Faaliyet Raporu Analizi: Kârlılık Odaklı Başarı

Raporun ana hikayesi, küresel ve yurt içi sanayi sektöründeki yavaşlamaya paralel olarak şirketin net satışlarının geçen yılın aynı dönemine göre **%13 düşmesine** rağmen, kârlılığını önemli ölçüde artırmasıdır. Bu durum, şirketin zorlu piyasa koşullarında maliyetlerini etkin bir şekilde yönettiğini ve operasyonel verimliliğini artırdığını göstermektedir.

### Pozitifler
1.  **Artan Kârlılık ve Marjlar:** Ciro düşüşüne rağmen **Brüt Kâr Marjı %23'ten %27'ye**, **EBITDA Marjı ise %9'dan %13'e yükselmiştir.** Bu, şirketin fiyatlama gücünü ve maliyet disiplinini koruduğunu kanıtlayan en güçlü sinyaldir.
2.  **Güçlü İç Talep (İnşaat):** İnşaat sektörünün, özellikle deprem bölgesi faaliyetleri sayesinde ekonomiden daha hızlı büyümesi (%7,3), mimari camlar segmenti için güçlü bir destek sağlamaktadır.
3.  **Geleceğe Yatırım:** İlk 6 ayda yapılan **14,6 Milyar TL'lik yatırım**, şirketin büyüme odaklı stratejisine devam ettiğini göstermektedir.
4.  **Güçlü İhracat Performansı:** 2025'in ilk 5 ayında Türkiye'nin cam ihracatının değer bazında **%15 artması**, Şişecam'ın uluslararası pazarlardaki rekabet gücünü teyit etmektedir.

### Negatifler / Riskler
1.  **Düşen Net Satışlar:** Küresel imalat sanayisindeki zayıflık, satış hacmini olumsuz etkilemiştir ve bu risk devam etmektedir.
2.  **Zayıf Otomotiv Pazarı:** AB ve Rusya gibi ana ihracat pazarlarındaki daralma, endüstriyel camlar segmenti üzerinde baskı oluşturmaktadır.
...
### Stratejik Değerlendirme (17 Ekim 2025): Ahmet Kırman Soruşturması

Bugün yayınlanan haberlere göre, şirketin eski Yönetim Kurulu Başkanı Ahmet Kırman, Can Holding'e yönelik bir "kara para aklama" soruşturması kapsamında "şüpheli" sıfatıyla ifade vermiş ve hakkında yurtdışı çıkış yasağı getirilmiştir.

*   **Etki Analizi:** Bu gelişmenin Şişecam'ın mevcut operasyonları üzerinde **doğrudan bir etki yaratması beklenmemektedir.** Ahmet Kırman, Temmuz 2024'te görevinden ayrılmış ve sonrasında yönetim, İş Bankası kökenli yöneticilerin ağırlıkta olduğu yeni bir yapıya kavuşmuştur. Haberde belirtilen ve Kırman'ın mimarı olduğu Ciner Grubu ile ortaklık gibi konular, yeni yönetim tarafından zaten sonlandırılmıştı.
*   **Risk Değerlendirmesi:** Ana risk, **kısa vadeli reputasyon riskidir.** Şirketin uzun yıllar en üst düzeyde yöneticiliğini yapmış bir ismin böyle bir soruşturmaya dahil olması, hisse üzerinde geçici bir satış baskısı ve negatif algı yaratabilir.
*   **Stratejik Sonuç:** Bu gelişme, şirketin temel yatırım tezini (operasyonel verimlilik, marj yönetimi, enerji maliyeti avantajı) değiştirmemektedir. Aksine, soruşturmanın yaratabileceği potansiyel bir fiyat düşüşü, mevcut **"KADEMELİ AL" stratejisi için yeni bir fırsat** olarak değerlendirilebilir. Soruşturmanın şirketin mevcut yönetimine sıçramadığı varsayımı altında, bu durum bir "fiyat gürültüsü" olarak görülmelidir.
